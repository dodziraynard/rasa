...
[2.8](https://github.com/RasaHQ/rasa/milestone/39) will be the last minor in the 2.x series, as we need this _minor freeze_ to be able to introduce architectural changes. You can still contribute new features and improvements which will be released together with 3.0. Read more about [our contributor guidelines](#how-to-contribute).
